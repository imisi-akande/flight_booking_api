# Generated by Django 2.1.3 on 2018-12-24 23:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arrival_location', models.CharField(max_length=255, null=True)),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='NGN', max_digits=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RESERVED', 'Reserved'), ('BOOKED', 'Booked'), ('CONFIRMED', 'Confirmed')], default='RESERVED', max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('confirmed_from', models.DateTimeField(blank=True, null=True)),
                ('flight', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='flight.Flight')),
            ],
            options={
                'abstract': False,
            },
